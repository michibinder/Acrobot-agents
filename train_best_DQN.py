...
for result in training_results:
    ...
    plt.plot(range(len(ep_reward)), ep_reward, lw=1.2, color='blue', label='Q-DQN (C:200, NN$_{dim}$:256)')
    plt.plot(range(len(running_reward)), running_reward, lw=1.2, color='red', label='EMA (stopped @ -75)')
